...
<body>
    ...
    <main>
        ...
        <h1 class="pokemon_data">
            <span class="pokemon_number"></span><?php echo $id;?> -
            <span class="pokemon_name"><?php echo $nome;?></span>
        </h1>
        ...
        <div class="buttons">
            <a href="index.php?id=<?php echo $anterior;?>" class="button btn-prev">&lt; Prev </a>
            <a href="index.php?id=<?php echo $proximo;?>" class="button btn-next">Next &gt;</a>
        </div>
